...
func on_stack_added(_new_total: int) -> void:
	pass


## Called when a stack is removed
func on_stack_removed(_new_total: int) -> void:
	pass
...
func on_turn_start(_player_index: int) -> void:
	pass


## Called at the end of a player's turn
func on_turn_end(_player_index: int) -> void:
...
func modify_damage_dealt(amount: int, _source: Node, _target: Node, _damage_type: String = "normal") -> int:
	return amount


## Modify damage before it's received. Return the modified amount.
func modify_damage_taken(amount: int, _source: Node, _target: Node, _damage_type: String = "normal") -> int:
	return amount


## Called after damage is dealt (for triggers, not modification)
func on_damage_dealt(_amount: int, _source: Node, _target: Node) -> void:
	pass


## Called after damage is received
func on_damage_taken(_amount: int, _source: Node, _target: Node) -> void:
	pass
...
func modify_healing(amount: int, _source: Node, _target: Node) -> int:
	return amount


## Called after healing is applied
func on_healing_applied(_amount: int, _source: Node, _target: Node) -> void:
	pass
...
func modify_card_cost(_card_data: Resource, base_cost: int, _player_index: int) -> int:
	return base_cost


## Modify a card's attack value
func modify_card_attack(_card_data: Resource, base_attack: int) -> int:
	return base_attack


## Modify a card's health value
func modify_card_health(_card_data: Resource, base_health: int) -> int:
	return base_health


## Called when a card is drawn
func on_card_drawn(_card_data: Resource, _player_index: int) -> void:
	pass


## Called when a card is played (before effects resolve)
func on_card_played(_card_data: Resource, _player_index: int, _target: Variant) -> void:
	pass


## Called after a card's effects have resolved
func on_card_resolved(_card_data: Resource, _player_index: int) -> void:
	pass


## Called when a card is discarded
func on_card_discarded(_card_data: Resource, _player_index: int) -> void:
	pass


## Check if a card can be played. Return false to prevent.
func can_play_card(_card_data: Resource, _player_index: int) -> bool:
	return true
...
func on_minion_summoned(_minion: Node, _player_index: int, _lane: int, _row: int) -> void:
	pass


## Called when a minion dies
func on_minion_death(_minion: Node, _player_index: int, _killer: Node) -> void:
	pass


## Called when a minion attacks
func on_minion_attack(_attacker: Node, _defender: Node) -> void:
	pass


## Modify a minion's attack stat on the board
func modify_minion_attack(_minion: Node, base_attack: int) -> int:
	return base_attack


## Modify a minion's health stat on the board
func modify_minion_health(_minion: Node, base_health: int) -> int:
	return base_health


## Check if a minion can attack. Return false to prevent.
func can_minion_attack(_minion: Node, _target: Node) -> bool:
	return true
...
func modify_hero_power_cost(_hero_power: Resource, base_cost: int, _player_index: int) -> int:
	return base_cost


## Called when a hero power is used
func on_hero_power_used(_hero_power: Resource, _player_index: int, _target: Variant) -> void:
	pass


## Check if hero power can be used. Return false to prevent.
func can_use_hero_power(_hero_power: Resource, _player_index: int) -> bool:
	return true
...
func modify_mana_gain(amount: int, _player_index: int) -> int:
	return amount


## Modify class resource gained
func modify_class_resource_gain(_resource_type: String, amount: int, _player_index: int) -> int:
	return amount


## Modify class resource spent
func modify_class_resource_cost(_resource_type: String, amount: int, _player_index: int) -> int:
	return amount
...
func can_target(_source: Node, _target: Node) -> bool:
	return true


## Modify available targets (return filtered array)
func filter_targets(_source: Node, available_targets: Array) -> Array:
...
func on_keyword_triggered(_keyword: String, _source: Node, _context: Dictionary) -> void:
	pass


## Modify keyword effectiveness (e.g., double Drain healing)
func modify_keyword_value(_keyword: String, base_value: int, _source: Node) -> int:
	return base_value
...
func modify_schedule_effect(_activity_type: String, effect_value: int) -> int:
	return effect_value


## Called when a schedule day completes
func on_schedule_day_complete(_day: int, _activity: String) -> void:
	pass
